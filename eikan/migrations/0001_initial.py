# Generated by Django 2.2.6 on 2019-11-11 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_id', models.ForeignKey(limit_choices_to={'admission_year__range': (eikan.models.pitcher_results.start_year, eikan.models.pitcher_results.finish_year), 'position': 1}, on_delete=django.db.models.deletion.CASCADE, to='eikan.Players', verbose_name='選手')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
                ('game_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eikan.Games')),
                ('player_id', models.ForeignKey(limit_choices_to={'admission_year__range': (eikan.models.fielder_results.start_year, eikan.models.fielder_results.finish_year)}, on_delete=django.db.models.deletion.CASCADE, to='eikan.Players', verbose_name='選手')),
            ],
            options={
                'verbose_name': '打者一覧',
