# Generated by Django 2.2.6 on 2019-12-04 15:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TeamsTotalResults',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.PositiveSmallIntegerField(default=0, editable=False, verbose_name='年度')),
                ('period', models.PositiveSmallIntegerField(default=0, editable=False, verbose_name='期間')),
                ...
                ('rank', models.PositiveSmallIntegerField(choices=[('', '選択'), (1, '弱小'), (2, 'そこそこ'), (3, '中堅'), (4, '強豪'), (5, '名門')], default=0, editable=False, verbose_name='ランク')),
                ...
                ('remark', models.CharField(blank=True, editable=False, max_length=100, null=True, verbose_name='備考')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='登録日')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
